...
class Unassigned extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->subject($username . ' unassigned you from ' . $this->task->name)
            ->markdown('mail.task.email.unassigned', ['task' => $this->task, 'username' => $username]);
    }
