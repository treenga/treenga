...
class Reopened extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->subject($username . ' reopened ' . $this->task->name)
            ->markdown('mail.task.email.reopened', ['task' => $this->task, 'username' => $username]);
    }
