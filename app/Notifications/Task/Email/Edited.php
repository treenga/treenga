...
class Edited extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->subject($username . ' changed ' . $this->task->name)
            ->markdown('mail.task.email.changes', ['task' => $this->task, 'username' => $username]);
    }
